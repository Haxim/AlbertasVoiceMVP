  ...
  return (
    <main className="mx-auto max-w-5xl px-4 py-10">
      <section className="border-b border-line pb-8">
        <p className="text-sm font-semibold uppercase tracking-wide text-petal">Captain Resources</p>
      ...
      <section className="mt-8 rounded-lg border border-line bg-white p-6 shadow-sm shadow-sky/10">
        <p className="text-sm font-semibold uppercase tracking-wide text-petal">Campaign Resource Ordering</p>
        <h2 className="mt-3 text-2xl font-bold text-ink">Coming soon</h2>
        <p className="mt-3 max-w-3xl leading-7 text-ink/75">
          Ordering for signs, printed materials, and other campaign resources will be available here soon.
        </p>
      </section>
    </main>
  );
